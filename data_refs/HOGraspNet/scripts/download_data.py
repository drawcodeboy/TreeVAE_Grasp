...
def main():
    ...
    os.makedirs(f"{args.output_folder}/zipped", exist_ok=True)
    ...
    for url_type in target_url_set:        
        ...
        output_path = f"{args.output_folder}/zipped/{url_type}"
    ...
    if args.objModel:
        ...
        output_path = f"{args.output_folder}/obj_scanned_models"
        os.makedirs(output_path, exist_ok=True)        
